  ...
  return (
    <div className='my-24'>
      ...
      <div className='space-y-6 w-1/2 mx-auto flex flex-col items-center'>
        <h2 className='text-2xl text-center font-bold text-slate-700'>Ready to get lost in a good book with <span className='text-accent animate-pulse'>Athena</span>?</h2>
